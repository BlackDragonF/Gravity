...
- (void) configure {
    ...
    _onTintColor = [UIColor clearColor];
...
//    _tintColor = [UIColor colorWithRed:0.90f green:0.90f blue:0.90f alpha:1.00f];
    ...
    _thumbLayer.frame = CGRectMake(0.0, 0.0, self.bounds.size.height, self.bounds.size.height);
    ...
    _thumbLayer.fillColor = [UIColor clearColor].CGColor;
...
- (CGRect) thumbFrameForState:(BOOL)isOn {
    return CGRectMake(isOn ? self.bounds.size.width-self.bounds.size.height+2.0 : 0,
                      0,
